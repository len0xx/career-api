...
В этой директории находятся все основные файлы, описывающие методы и типы объектов, используемые в API
...
* [objects — Объекты](https://github.com/len0xx/career-api/blob/main/docs/objects.md)
